...
GLEN_EDEN_DIR = Path(__file__).resolve().parent
CRAWLER_DIR = GLEN_EDEN_DIR.parents[1]
SNAPSHOT_GENERATOR = GLEN_EDEN_DIR / "snapshot_generator.py"
SNAPSHOT_FILE = GLEN_EDEN_DIR / "snapshot_generator.json"
TABLE_NAMES = (
    "resorts",
    "resortHours",
    "resortRates",
