...
CHICOPEE_DIR = Path(__file__).resolve().parent
CRAWLER_DIR = CHICOPEE_DIR.parents[1]
SNAPSHOT_GENERATOR = CHICOPEE_DIR / "snapshot_generator.py"
SNAPSHOT_FILE = CHICOPEE_DIR / "snapshot_generator.json"
TABLE_NAMES = (
    "resorts",
    "resortHours",
    "resortRates",
